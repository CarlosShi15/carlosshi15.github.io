...
<table style="width:100%; border-collapse: collapse;">
  <thead>
    <tr style="background-color: #f2f2f2;">
      ...
      <th style="width:45%; padding:12px; border:1px solid #ddd;">Organization</th>
      <th style="width:25%; padding:12px; border:1px solid #ddd;">Duration</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="padding:10px; border:1px solid #ddd;">Vice President</td>
      <td style="padding:10px; border:1px solid #ddd;">Class 2209, SUSTech</td>
      <td style="padding:10px; border:1px solid #ddd;">September 2022 – Present</td>
    </tr>
    <tr style="background-color: #f9f9f9;">
      <td style="padding:10px; border:1px solid #ddd;">Defensive Midfielder</td>
      <td style="padding:10px; border:1px solid #ddd;">SUSTech Soccer Club</td>
      <td style="padding:10px; border:1px solid #ddd;">May 2024 – May 2025</td>
    </tr>
    <tr>
      <td style="padding:10px; border:1px solid #ddd;">Deputy Secretary</td>
      <td style="padding:10px; border:1px solid #ddd;">Youth League Committee, Shuli College, SUSTech</td>
      <td style="padding:10px; border:1px solid #ddd;">September 2023 – June 2024</td>
    </tr>
    <tr style="background-color: #f9f9f9;">
      <td style="padding:10px; border:1px solid #ddd;">Member</td>
      <td style="padding:10px; border:1px solid #ddd;">Senior Fellows Group, Shuli College, SUSTech</td>
      <td style="padding:10px; border:1px solid #ddd;">September 2023 – June 2024</td>
    </tr>
  </tbody>
</table>
